  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2 h-full text-xl">
        <img src={meme} className="p-5" />
        <div className="flex justify-center space-x-5">
          <button className="relative text-[#3E2723] inline-block font-medium text-[15px] w-[90px] cursor-pointer border-none bg-white hover:text-white transition-colors duration-500
      ...
      group">
          ...
          <button className="relative text-[#3E2723] inline-block font-medium text-[15px] w-fit px-4 py-1 cursor-pointer border-none bg-white hover:text-white transition-colors duration-500
      before:content-[''] before:absolute before:top-0 before:bottom-0 before:left-0 before:right-full before:bg-[#3E2723] before:opacity-0 before:-z-10 before:transition-all before:duration-500
      hover:before:right-0 hover:before:opacity-100
      -skew-x-[21deg]
      group">
